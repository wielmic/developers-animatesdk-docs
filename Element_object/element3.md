...
**name** A string that specifies the name of the persistent data item (set with [element.setPersistentData()](#!wielmic/developers-animatesdk-docs/test/Element_object/elemen17.md)).
...
[element.setPublishPersistentData()](#!wielmic/developers-animatesdk-docs/test/Element_object/elemen18.md)
