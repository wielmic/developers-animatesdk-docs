...
**fill** A Fill object that specifies the fill settings to be used. See [Fill object](#!wielmic/developers-animatesdk-docs/test/Fill_object/fill_summary.md).
...
[document.getCustomFill()](#!wielmic/developers-animatesdk-docs/test/Document_object/docume74.md)
