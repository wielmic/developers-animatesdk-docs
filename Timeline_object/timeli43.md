...
**property** A string that specifies the name of the property to be modified. For a complete list of properties and values, see the Property summary for the [Frame object](#!wielmic/developers-animatesdk-docs/test/Frame_object/frame_summary.md).
You can’t use this method to set values for read-only properties such as [frame.duration](#!wielmic/developers-animatesdk-docs/test/Frame_object/frame4.md) and [frame.elements](#!wielmic/developers-animatesdk-docs/test/Frame_object/frame5.md).
**value** Specifies the value to which you want to set the property. To determine the appropriate values and type, see the Property summary for the [Frame object](#!wielmic/developers-animatesdk-docs/test/Frame_object/frame_summary.md).
