...
**property** A string that specifies the name of the property whose value you want to retrieve. For a list of properties, see the Property summary for the [Frame object](#!wielmic/developers-animatesdk-docs/test/Frame_object/frame_summary.md).
