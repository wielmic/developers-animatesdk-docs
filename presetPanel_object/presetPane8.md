...
To create XML files that can be imported, use [presetPanel.exportItem()](#!wielmic/developers-animatesdk-docs/test/presetPanel_object/presetPane5.md).
...
[presetPanel.exportItem()](#!wielmic/developers-animatesdk-docs/test/presetPanel_object/presetPane5.md)
