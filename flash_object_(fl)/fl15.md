...
Method; silently copies a library item from a document without exposing the item in the Flash Pro user interface. Call the [document.clipPaste()](#!wielmic/developers-animatesdk-docs/test/Document_object/docume32.md) method to paste the item into the new document.
