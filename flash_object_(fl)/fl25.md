...
Method; lets you target a specific file by using its unique identifier (instead of its index value, for example). Use this method in conjunction with [document.id](#!wielmic/developers-animatesdk-docs/test/Document_object/docume92.md).
...
[fl.findDocumentIndex()](#!wielmic/developers-animatesdk-docs/test/flash_object_(fl)/fl26.md))
