...
```javascript
The following example creates a folder and a subfolder under the configuration folder ([fl.configURI](#!wielmic/developers-animatesdk-docs/test/flash_object_(fl)/fl13.md)):
...
[FLfile.remove()](#!wielmic/developers-animatesdk-docs/test/FLfile_object/FLfile12.md), [FLfile.write()](#!wielmic/developers-animatesdk-docs/test/FLfile_object/FLfile15.md)
